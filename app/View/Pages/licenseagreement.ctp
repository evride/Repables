...
<h3>Repables LLC. Terms of Use</h3>

<p>(Effective as of March 18, 2014)</p>
<br/>

<p>If you would like to submit a complaint or suggestion regarding this license agreement please go to our feedback page at <a href="<?php echo $this->Html->url('/feedback', true); ?>"><?php echo $this->Html->url('/feedback', true); ?></a></p>

<br/> 

<p>Welcome to the Repables LLC. (the "Company") service (the “Service”).  The following Terms of Use apply when you view or use the Service via our website located at repables.com.  Please review the following terms carefully.  By accessing or using the Service, you signify your agreement to these Terms of Use.  If you do not agree to these Terms of Use, you may not access or use the Service.</p>

<h4>PRIVACY POLICY</h4>

<p>The Company respects the privacy of its Service users.  Please refer to the Company’s <a href="<?php echo $this->Html->url('/privacypolicy/'); ?>">Privacy Policy</a> which explains how we collect, use, and disclose information that pertains to your privacy.  When you access or use the Service, you signify your agreement to this Privacy Policy.</p>

<h4>ABOUT THE SERVICE</h4>

<p>The Service allows you to upload files and provide a description of the files. You and other users may view the files, download the files, and discuss the files with other users. </p>

<h4>REGISTRATION; RULES FOR USER CONDUCT AND USE OF THE SERVICE</h4>

<p>If you are a resident of the United States you must be at least 13 years old to register for the Service. Residents of all other countries are welcome to join, too.</p>
...
<ol>
	...
	<li>A description of the material that is claimed to be infringing or to be the subject of infringing activity and information sufficient to enable us to locate such work;
	Information reasonably sufficient to permit the service provider to contact you, such as an address, telephone number, and/or email address;</li>
...
<p>By posting any User Content via the Service, you expressly grant, and you represent and warrant that you have a right to grant, to the Company a royalty-free, worldwide license to use, reproduce, modify, publish, list information regarding, edit, translate, distribute, publicly display, and make derivative works of all such User Content including user profile information as contained in your User Content, if applicable, in whole or in part, and in any form, media or technology, whether now known or hereafter developed, for use in connection with the Service. If you decide to remove User Content from the Service the license will be revoked 60 days after the removal request.</p>
...
<p>We may also use your email address, to send you other messages, including information about the Company. You may opt out of such email by changing your account settings or sending an email to unsubscribe@repables.com. Opting out may prevent you from receiving messages regarding the Company.</p>
...
<p>These Terms of Use and your use of the Site are governed by the federal laws of the United States of America and the laws of the State of Kentucky, without regard to conflict of law provisions.</p>
