...
window.jQuery.tableDnD = {
        ...
        config.dragHandle
            ...
            && $(config.dragHandle, table).each(function() {
                ...
                $(this).bind(startEvent, function(e) {
                    $.tableDnD.initialiseDrag($(this).parents('tbody')[0], table, this, e, config);
                    return false;
                });
            })
    ...
    currentOrder: function() {
        var rows = this.currentTable.tBodies;
    ...
    findDropTargetRow: function(draggedRow, y) {
        var rowHeight = 0,
            rows      = this.currentTable.tBodies,
    ...
    processMouseup: function() {
        ...
        config.hierarchyLevel
            ...
            && $(this.currentTable.tBodies).first().find('td:first').children().each(function () {
            ...
            && $(this.currentTable.tBodies).each(function () {
